...
async def bot_invite(ctx):
    embed=discord.Embed(title="Bot invite", description="[Invite me!](https://discord.com/api/oauth2/authorize?client_id=879838096466796545&permissions=0&scope=bot%20applications.commands)", color=0xc84268)
